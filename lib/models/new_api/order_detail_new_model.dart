class OrderDetailResponseNew {
  OrderDetailNew? order;
...
class SalesOrderSalesman {
  String? salesmanId;
  String? code;
  String? name;

  SalesOrderSalesman({this.salesmanId, this.code, this.name});

  SalesOrderSalesman.fromJson(Map<String, dynamic> json) {
