class SalesWaybillsResponse {
  Waybills? waybills;

  SalesWaybillsResponse({this.waybills});

  SalesWaybillsResponse.fromJson(Map<String, dynamic> json) {
...
class Waybills {
  ...
  Waybills.fromJson(Map<String, dynamic> json) {
    if (json['items'] != null) {
      items = <SalesWaybillsItems>[];
      json['items'].forEach((v) {
        items!.add(new SalesWaybillsItems.fromJson(v));
      });
    }
...
class SalesWaybillsItems {
  ...
  SalesWaybillsItems.fromJson(Map<String, dynamic> json) {
