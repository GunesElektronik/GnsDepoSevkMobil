class PurchaseOrderSummaryListResponse {
  PurchaseOrderSummaryOrder? orders;

  PurchaseOrderSummaryListResponse({this.orders});

  PurchaseOrderSummaryListResponse.fromJson(Map<String, dynamic> json) {
    orders = json['orders'] != null
        ? new PurchaseOrderSummaryOrder.fromJson(json['orders'])
        : null;
  }
...
class PurchaseOrderSummaryOrder {
  List<PurchaseOrderSummaryItem>? items;
  int? totalItems;
  int? page;
  int? pageSize;

  PurchaseOrderSummaryOrder(
      {this.items, this.totalItems, this.page, this.pageSize});

  PurchaseOrderSummaryOrder.fromJson(Map<String, dynamic> json) {
    if (json['items'] != null) {
      items = <PurchaseOrderSummaryItem>[];
      json['items'].forEach((v) {
        items!.add(new PurchaseOrderSummaryItem.fromJson(v));
      });
    }
...
class PurchaseOrderSummaryItem {
  String? orderId;
  String? ficheNo;
  DateTime? ficheDate;
  String? customer;
  ...
  PurchaseOrderSummaryItem({
    ...
    required this.isPartialOrder,
  });

  PurchaseOrderSummaryItem.fromJson(Map<String, dynamic> json) {
