class OverCountFicheDetailResponse {
  OverCountFiche? overCountFiche;

  OverCountFicheDetailResponse({this.overCountFiche});

  OverCountFicheDetailResponse.fromJson(Map<String, dynamic> json) {
    overCountFiche = json['overCountFiche'] != null
        ? new OverCountFiche.fromJson(json['overCountFiche'])
        : null;
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.overCountFiche != null) {
      data['overCountFiche'] = this.overCountFiche!.toJson();
    }
    return data;
  }
}

class OverCountFiche {
  ...
  OverCountFiche.fromJson(Map<String, dynamic> json) {
    ...
    customerAddress = json['customerAddress'] != null
        ...
        : null;
    if (json['overCountFicheItems'] != null) {
      overCountFicheItems = <OverCountFicheItems>[];
      json['overCountFicheItems'].forEach((v) {
        overCountFicheItems!.add(new OverCountFicheItems.fromJson(v));
      });
    }
    project =
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.overCountFicheItems != null) {
      data['overCountFicheItems'] =
          this.overCountFicheItems!.map((v) => v.toJson()).toList();
    }
...
class OverCountFicheItems {
  ...
  OverCountFicheItems.fromJson(Map<String, dynamic> json) {
    overCountFicheItemId = json['overCountFicheItemId'];
    product =
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['overCountFicheItemId'] = this.overCountFicheItemId;
