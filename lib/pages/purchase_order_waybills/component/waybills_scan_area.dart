...
class WaybillScanArea extends StatefulWidget {
  const WaybillScanArea(
      {super.key,
  ...
  @override
  State<WaybillScanArea> createState() => _WaybillScanAreaState();
}

class _WaybillScanAreaState extends State<WaybillScanArea>
