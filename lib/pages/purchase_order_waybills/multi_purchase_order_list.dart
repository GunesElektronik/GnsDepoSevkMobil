...
import 'package:gns_warehouse/pages/purchase_order_waybills/waybills_order_detail.dart';
...
class MultiPurchaseOrderList extends StatefulWidget {
  const MultiPurchaseOrderList({super.key});

  @override
  State<MultiPurchaseOrderList> createState() => _MultiPurchaseOrderListState();
}

class _MultiPurchaseOrderListState extends State<MultiPurchaseOrderList> {
  ...
  void firstLoad() async {
    var results = await _dbHelper.getMultiOrderHeaderList();
    setState(() {
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => WaybillsOrderDetail(
                  waybillsId: productItem.waybillsId,
