...
class CreateOverCountFichePage extends StatefulWidget {
...
class _CreateOverCountFichePageState extends State<CreateOverCountFichePage> {
  ...
  Future<OverCountFicheRequestBody> _createTransferBody() async {
    return OverCountFicheRequestBody(
      ...
      erpCode: "",
      projectId: projectId,
      overCountFicheItem: _createWarehouseTransferItems(),
    );
  }

  List<OverCountFicheItem> _createWarehouseTransferItems() {
    List<OverCountFicheItem> list = [];
    transferProductList.forEach((element) {
      OverCountFicheItem item = OverCountFicheItem(
