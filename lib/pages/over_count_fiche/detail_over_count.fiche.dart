...
class OverCountFicheDetail extends StatefulWidget {
  OverCountFicheDetail({super.key, required this.overCountFicheId});
  String overCountFicheId;
  @override
  State<OverCountFicheDetail> createState() => _OverCountFicheDetailState();
}

class _OverCountFicheDetailState extends State<OverCountFicheDetail> {
  late ApiRepository apiRepository;
  bool isFetched = false;
  late OverCountFicheDetailResponse detailResponse;
  late List<OverCountFicheItems> overCountFicheItemList;
        ...
        child: Column(
          children: [
            ...
            ListView.builder(
                primary: false,
                shrinkWrap: true,
                itemCount: overCountFicheItemList.length,
