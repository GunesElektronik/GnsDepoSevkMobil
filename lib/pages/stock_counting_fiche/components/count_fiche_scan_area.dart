...
class CountFicheScanArea extends StatefulWidget {
  const CountFicheScanArea(
      {super.key,
  ...
  @override
  State<CountFicheScanArea> createState() => _CountFicheScanAreaState();
}

class _CountFicheScanAreaState extends State<CountFicheScanArea>
  ...
  DefaultTabController _body(BuildContext context) {
