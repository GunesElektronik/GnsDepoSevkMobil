...
class MultiSalesOrderScanProductItemRow extends StatefulWidget {
  MultiSalesOrderScanProductItemRow({
    super.key,
    required this.item,
    required this.index,
  ...
  @override
  State<MultiSalesOrderScanProductItemRow> createState() =>
      _MultiSalesOrderScanProductItemRowState();
}

class _MultiSalesOrderScanProductItemRowState
    extends State<MultiSalesOrderScanProductItemRow> {
  ...
  @override
  void didUpdateWidget(MultiSalesOrderScanProductItemRow oldWidget) {
  ...
  _deneme1() async {
    await _dbHelper.addMultiSalesOrderScannedItem(
      widget.item.recid!,
    ...
    waybillsOrderDetailScannedItems =
        await _dbHelper.getMultiSalesOrderScannedItem(widget.item.recid!,
            widget.item.waybillsId!, widget.item.productId!);
    localScanned += widget.scannedTimes;
    totalScannedQty += widget.scannedTimes;
    await _dbHelper.updateMultiSalesOrderDetailItemScannedQty(
        localScanned,
        widget.item.recid!,
        widget.item.waybillsId!,
        widget.item.productId!,
  ...
  _deneme2(WaybillScannedItemDB item) async {
    await _dbHelper.clearMultiSalesOrderScannedItem(
