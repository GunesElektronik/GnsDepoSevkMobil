...
import 'package:gns_warehouse/pages/create_order/common_components/gns_shipping_type/gns_shipping_type_bottom_sheet.dart';

class GNSSelectShippingType extends StatefulWidget {
  const GNSSelectShippingType({
    super.key,
  ...
  @override
  State<GNSSelectShippingType> createState() => _GNSSelectShippingTypeState();
  final bool isErrorActive;
  final ValueChanged<String> onValueChanged;
}

class _GNSSelectShippingTypeState extends State<GNSSelectShippingType> {
  bool isFetched = false;

  String shippingTypeNameInit = "Sevk Tipi";
  String shippingTypeDefinition = "Sevk Tipi";
  ...
  @override
  void didUpdateWidget(GNSSelectShippingType oldWidget) {
  ...
  Widget build(BuildContext context) {
    return _row(shippingTypeDefinition, shippingTypeNameInit, () {
      showModalBottomSheet(
        ...
        // ),
        builder: (context) => GNSShippingTypeBottom(
          onValueChanged: (value) async {
            shippingTypeDefinition = value.shippingTypeDefinition;
  ...
  void updateInfo() {
    widget.onValueChanged(shippingTypeId);
  }
