...
import 'package:gns_warehouse/pages/create_order/common_components/gns_select_salesman/gns_salesman_bottom_sheet.dart';

class GNSSelectSalesmen extends StatefulWidget {
  const GNSSelectSalesmen({
    super.key,
  ...
  @override
  State<GNSSelectSalesmen> createState() => _GNSSelectSalesmenState();
  final bool isErrorActive;
  final ValueChanged<String> onValueChanged;
}

class _GNSSelectSalesmenState extends State<GNSSelectSalesmen> {
  bool isFetched = false;

  String salesmanNameInit = "Satıcı";
  ...
  @override
  void didUpdateWidget(GNSSelectSalesmen oldWidget) {
  ...
  Widget build(BuildContext context) {
    return _row(salesmanName, salesmanNameInit, () {
      showModalBottomSheet(
        ...
        // ),
        builder: (context) => GNSSalesmanBottom(
          onValueChanged: (value) async {
            salesmanName = value.salesmanName;
            salesmanId = value.salesmenId;
  ...
  void updateInfo() {
    widget.onValueChanged(salesmanId);
  }
