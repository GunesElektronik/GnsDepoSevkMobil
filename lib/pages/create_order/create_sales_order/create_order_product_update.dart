...
class CreateSalesOrderProductUpdate extends StatefulWidget {
  CreateSalesOrderProductUpdate({
    super.key,
  ...
  final ValueChanged<ProductDetailAndScannedNumberForSalesOrderCreate>
      onValueChanged;
  @override
  State<CreateSalesOrderProductUpdate> createState() =>
      _CreateSalesOrderProductUpdateState();
}

class _CreateSalesOrderProductUpdateState
    extends State<CreateSalesOrderProductUpdate> {
  ...
  void _createWarehouseTransferItems() {
    SalesOrderItems updatedBodyItem = SalesOrderItems(
      productId: productId,
      ...
      orderitemtype: widget.oldItem.bodyItem.orderitemtype,
    ...
    ProductDetailAndScannedNumberForSalesOrderCreate updatedItem =
