...
class GNSWhsTrsProjectBottom extends StatefulWidget {
  const GNSWhsTrsProjectBottom({super.key, required this.onValueChanged});
  final ValueChanged<ProjectBottomSheetReturn> onValueChanged;
  @override
  State<GNSWhsTrsProjectBottom> createState() => _GNSWhsTrsProjectBottomState();
}

class _GNSWhsTrsProjectBottomState extends State<GNSWhsTrsProjectBottom> {
  late ApiRepository apiRepository;
  TextEditingController _searchController = TextEditingController();
  List<ProjectItems> filteredItems = [];
  bool isFetched = false;
  bool isLoading = false;
  int projectPage = 1;
  late ProjectListResponse? projectsResponse;
  String query = "";
  String projectId = "";
  String projectName = "Taşıyıcı";
  ...
  _createApiRepository() async {
    ...
    projectsResponse =
        await apiRepository.getProjectListSearch(projectPage, query);
    filteredItems = projectsResponse!.projects!.items!;
    setState(() {
      isFetched = true;
    });
  }
  ...
  void _filterUsingService(String query) async {
    ...
    var newResponse =
        await apiRepository.getProjectListSearch(projectPage, query);
    filteredItems = filteredItems + newResponse!.projects!.items!;
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return _selectingAreaRowItem(
                                  ...
                                  projectName = filteredItems[index].code!;
                                  projectId = filteredItems[index].projectId!;
  ...
  void updateInfo() {
    ProjectBottomSheetReturn info = ProjectBottomSheetReturn(
      projectId: projectId,
...
class ProjectBottomSheetReturn {
  final String projectId;
  final String projectName;

  ProjectBottomSheetReturn({
