...
class UserWarehouseOutSettingsPage extends StatefulWidget {
  ...
  @override
  State<UserWarehouseOutSettingsPage> createState() =>
      _UserWarehouseOutSettingsPageState();
}

class _UserWarehouseOutSettingsPageState
    extends State<UserWarehouseOutSettingsPage>
  ...
  int userSpecialSettingCardId = 3;
  @override
                ...
                itemBuilder: (context, index) {
                  ...
                  return UserSpecialWarehouseItemRow(
                      ...
                      isSelected: (newValue) {
                        ...
                        finalWarehouseList.forEach((element) {
                          print("warehouse: ${element.warehouse}");
                        });
                      },
