...
import 'package:gns_warehouse/pages/order_irsaliye/order_irsaliye_control.dart';
...
class IrsaliyeOrder extends StatefulWidget {
  const IrsaliyeOrder({super.key});

  @override
  State<IrsaliyeOrder> createState() => _IrsaliyeOrderState();
}

class _IrsaliyeOrderState extends State<IrsaliyeOrder> {
  String employeeName = "";
              ...
              _button(
                ...
                () {
                  ...
                  Navigator.of(context).push<String>(MaterialPageRoute(
                    builder: (context) => const IrsaliyeOrderControl(),
                  ));
                  */
                },
              ),
