...
class IrsaliyeOrderScan extends StatefulWidget {
  const IrsaliyeOrderScan({super.key});

  @override
  State<IrsaliyeOrderScan> createState() => _IrsaliyeOrderScanState();
}

class _IrsaliyeOrderScanState extends State<IrsaliyeOrderScan> {
  String barcode = "";
