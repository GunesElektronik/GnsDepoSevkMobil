...
class PurchaseOrderListItemRow extends StatefulWidget {
  PurchaseOrderListItemRow(
      {super.key,
      required this.item,
  ...
  @override
  State<PurchaseOrderListItemRow> createState() =>
      _PurchaseOrderListItemRowState();
}

class _PurchaseOrderListItemRowState extends State<PurchaseOrderListItemRow> {
