...
class MinusCountProductUpdate extends StatefulWidget {
  MinusCountProductUpdate({
    super.key,
  ...
  TransferFicheLocalItems oldItem;
  final ValueChanged<TransferFicheLocalItems> onValueChanged;
  @override
  State<MinusCountProductUpdate> createState() =>
      _MinusCountProductUpdateState();
}

class _MinusCountProductUpdateState extends State<MinusCountProductUpdate> {
  ...
  void _createWarehouseTransferItems() {
    TransferFicheLocalItems updatedItem = TransferFicheLocalItems(
      productId: productId,
