...
import 'package:gns_warehouse/models/order_summary_entity.dart';
...
import 'package:gns_warehouse/pages/multi_sales_order/create_multi_sales_order.dart';
import 'package:gns_warehouse/pages/multi_sales_order/multi_sales_order_list.dart';
import 'package:gns_warehouse/pages/order_detail/order_detail_deneme.dart';
import 'package:gns_warehouse/pages/order_irsaliye/order_irsaliye.dart';
import 'package:gns_warehouse/pages/sales_order/sales_order_detail_local.dart';
import 'package:gns_warehouse/pages/sales_order/sales_order_detail_remote.dart';
import 'package:gns_warehouse/pages/sales_order/sales_order_item_local_list.dart';
...
class _OrderListState extends State<OrderList> {
  ...
  List<OrderSummary>? orderHeaderList = [];
  bool? isOnlyIsAssingFalse = false;
  bool? ordersAssingedToMe = false;
  ...
  OrderSummaryListResponseNew? summaryListResponse;
  bool isConnected = true;
  int summaryPage = 1;
  String remoteQuery = "";
  List<OrderSummaryItem> remoteSummaryList = [];
  ...
  _createApiRepository() async {
    ...
    try {
      summaryListResponse = await apiRepository.getOrderSummaryListSearch(
  ...
  Future<void> _filterUsingService(String query) async {
    ...
    var newResponse = await apiRepository.getOrderSummaryListSearch(
  ...
  void performSearch(String query) async {
    if (query.isNotEmpty && query.length > 0) {
      var results = await _dbHelper.searchOrderHeader(query);
      ...
      if (ordersAssingedToMe!) {
        results = results!.where((element) => element.assingmetFullname == apiRepository.employeeName).toList();
      }
      ...
      var results = await _dbHelper.getOrderHeaderList();
  ...
  void _getSettingsValues() async {
    var sharedValue = await sharedPreferences.get(sharedPreferencesKey.isOnlyIsAssingFalseForOrder);
    if (sharedValue != null) {
      isOnlyIsAssingFalse = sharedValue as bool;
    }

    var sharedOrdersAssingedToMe = await sharedPreferences.get(sharedPreferencesKey.ordersAssingedToMe);
    if (sharedOrdersAssingedToMe != null) {
      ordersAssingedToMe = sharedOrdersAssingedToMe as bool;
    }
                      ...
                      child: SizedBox(
                        ...
                        child: Card(
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => const CreateSalesOrder()))
                                  .then((value) async {
                                //firstLoad();
                              });
                            },
                      ...
                      child: SizedBox(
                        ...
                        child: Card(
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              Navigator.push(
                                      context, MaterialPageRoute(builder: (context) => const SalesOrderItemLocalList()))
                                  .then((value) async {
                                //firstLoad();
                              });
                            },
                      ...
                      child: SizedBox(
                        ...
                        child: Card(
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              Navigator.push(
                                      context, MaterialPageRoute(builder: (context) => const MultiSalesOrderList()))
                                  .then((value) async {
                                //firstLoad();
                              });
                            },
                  ...
                  Padding(
                    ...
                    child: Center(
                      child: SizedBox(
                        ...
                        */
                              Navigator.push(
                                      context, MaterialPageRoute(builder: (context) => const CreateMultiSalesOrder()))
                                  .then((value) async {
                                //firstLoad();
                              });
                            },
              ...
              child: SizedBox(
                ...
                child: Card(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Navigator.of(context).push<String>(MaterialPageRoute(
                        builder: (context) => const IrsaliyeOrder(),
                      ));
                    },
                    child: Container(
                        decoration: BoxDecoration(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CheckboxListTile(
                  value: ordersAssingedToMe,
                  contentPadding: EdgeInsets.zero,
                  activeColor: Colors.amber,
                  controlAffinity: ListTileControlAffinity.leading,
                  onChanged: (newBool) {
                    setState(() {
                      ordersAssingedToMe = newBool;
                      //print(isOnlyIsAssingTrue);
                    });
                  },
                  title: const Text(
                    "Sadece Bana Atanmış Siparişler",
                    textAlign: TextAlign.start,
                  ),
                ),
  ...
  Widget orderHeaderInfo(OrderSummary productItem) {
    return Padding(
          ...
          onTap: () {
            ...
            */
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => SalesOrderDetailLocal(
                          item: _convertToOrderSummaryItem(productItem),
                        ))).then((value) async {
              //firstLoad();
            });
  ...
  OrderSummaryItem _convertToOrderSummaryItem(OrderSummary productItem) {
  ...
  Widget _remoteOrderItemRow(OrderSummaryItem productItem, int index) {
    return Padding(
      padding: EdgeInsets.only(bottom: 10),
      child: Container(
        decoration: BoxDecoration(color: Colors.amber, borderRadius: BorderRadius.circular(8)),
  ...
  Widget bottomSheet(OrderSummary productItem) {
    double leftPadding = 8.0;
    return Container(
      width: double.infinity,
      height: 400,
