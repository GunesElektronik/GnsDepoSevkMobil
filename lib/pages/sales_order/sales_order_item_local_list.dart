...
class SalesOrderItemLocalList extends StatefulWidget {
  const SalesOrderItemLocalList({super.key});

  @override
  State<SalesOrderItemLocalList> createState() =>
      _SalesOrderItemLocalListState();
}

class _SalesOrderItemLocalListState extends State<SalesOrderItemLocalList> {
